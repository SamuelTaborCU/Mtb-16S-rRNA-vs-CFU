...
ggsave(file.path(plot_dir, "T95 of the regimens.jpg"), width = 9, height = 6.75)
...
CFU <- ggplot(data = New_modeling_data, aes(T95, mean_CFU, col=Group))+
  ...
  scale_colour_manual(values = c("PreRx"="grey50","HRZE"= "#E4B811","PaMZ"= "#00A9FF","BDOS"="forestgreen",
                                 ...
                                 "BZM"="gold4","BZMRb"="blue","BPaMZ"="red","BDO286" = "pink","BDO830" = "blue4","BD286S" = "green","BPa286S" = "orange","BD830S" = "brown1",
                                 "BPa830S" = "deepskyblue","BPaO286" = "coral3","BOS286" = "bisque","DOS286" = "azure2","PaOS286" = "firebrick"),) +
...
ggsave(file.path(supp_dir, "CFU VS T95 at different timepoints.jpg"), CFU, width = 9, height = 6, units = "in")
...
ggsave(file.path(supp_dir, "CFU VS T95  day 28.jpg"), CFU28, width = 7, height = 6, units = "in")
...
ggsave(file.path(supp_dir, "16S rRNA  VS T95 at different timepoints.jpg"), A16S.rRNA, width = 9, height = 6, units = "in")
...
ggsave(file.path(supp_dir, "16S rRNA VS T95 day 28.jpg"), A16S.rRNA28, width = 7, height = 6, units = "in")
...
ggsave(file.path(plot_dir, "Model 1 T95 predicted vs observed.jpg"), plot = model1, width = 7, height = 6, units = "in", dpi = 300)
ggsave(file.path(plot_dir, "Model 2  T95 predicted vs observed.jpg"), plot = model2, width = 7, height = 6, units = "in", dpi = 300)
ggsave(file.path(plot_dir, "Model 3  T95 predicted vs observed.jpg"), plot = model3, width = 7, height = 6, units = "in", dpi = 300)
